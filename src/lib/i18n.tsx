...
const messages = {
  en: {
    ...
    "connections.schemaCount": "{count} schemas",
    "connections.sourceCount": "{count} sources",
    ...
    "connections.viewOptionsHint": "Grouping, row counts, and hidden/system objects belong here.",
  ...
  ko: {
    ...
    "connections.schemaCount": "스키마 {count}개",
    "connections.sourceCount": "소스 {count}개",
    ...
    "connections.viewOptionsHint": "그룹, 행 수, 숨김/시스템 객체 표시 옵션을 여기에 둡니다.",
